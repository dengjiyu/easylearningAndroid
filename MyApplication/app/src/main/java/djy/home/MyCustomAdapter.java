...
public class MyCustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            //获取list_item布局文件的视图
            convertView = mInflater.inflate(R.layout.paizhaotiwen_item, null);//View未被实例化，缓冲池中也无缓存
        }
        {
            listItemView = new ListItemView();
            //获取控件对象
            listItemView.a = (ImageView)convertView.findViewById(R.id.t3);
            listItemView.b = (TextView)convertView.findViewById(R.id.t1);
            listItemView.c = (TextView)convertView.findViewById(R.id.t2);
            ...
            listItemView.c.setText((String) listItems.get(position).get("text1"));
